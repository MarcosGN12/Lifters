...
let TrainingPlanController = (() => {
    let _classDecorators = [(0, common_1.Controller)('training-plans')];
    ...
    var TrainingPlanController = _classThis = class {
        constructor(trainingPlanService) {
            this.trainingPlanService = (__runInitializers(this, _instanceExtraInitializers), trainingPlanService);
        }
    ...
    __setFunctionName(_classThis, "TrainingPlanController");
    (() => {
        ...
        TrainingPlanController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TrainingPlanController = _classThis;
})();
