...
let WorkoutsController = (() => {
    let _classDecorators = [(0, common_1.Controller)('workouts')];
    ...
    var WorkoutsController = _classThis = class {
        constructor(workoutsService) {
            this.workoutsService = (__runInitializers(this, _instanceExtraInitializers), workoutsService);
        }
    ...
    __setFunctionName(_classThis, "WorkoutsController");
    (() => {
        ...
        WorkoutsController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return WorkoutsController = _classThis;
})();
