...
let Exercise = (() => {
    let _classDecorators = [(0, typeorm_1.Entity)(), (0, typeorm_1.Unique)(['name', 'userId'])];
    ...
    (() => {
        ...
        _user_decorators = [(0, typeorm_1.ManyToOne)(() => user_entity_1.User, (user) => user.exercises, {
                onDelete: 'CASCADE',
            })];
