...
let ExercisesController = (() => {
    let _classDecorators = [(0, common_1.Controller)('exercises')];
    ...
    var ExercisesController = _classThis = class {
        constructor(exercisesService) {
            this.exercisesService = (__runInitializers(this, _instanceExtraInitializers), exercisesService);
        }
    ...
    __setFunctionName(_classThis, "ExercisesController");
    (() => {
        ...
        ExercisesController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ExercisesController = _classThis;
})();
